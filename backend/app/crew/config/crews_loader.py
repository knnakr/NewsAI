...
from app.crew.config.crew_schema import CrewsFileConfig
 ...
 # Crew yapılandırma dosyasının yerini döndürür.
def _config_path() -> Path:
	return Path(__file__).with_name("crews.yaml")


 # YAML crew tanımlarını doğrulayarak uygulama içinde kullanılabilir hale getirir.
def load_crew_configs() -> CrewsFileConfig:
 ...
 # Agent ve task referanslarını bağlayarak çalıştırılabilir Crew nesneleri oluşturur.
